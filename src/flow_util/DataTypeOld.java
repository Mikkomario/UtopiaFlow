...
/**
 * TAn instance of this class represents a simple data type
 * @author Mikko Hilpinen
 * @since 2.10.2015
 */
public class DataTypeOld
{
	// ATTRIBUTES	---------------
	 ...
	 */
	public static DataTypeOld DATETIME = new DataTypeOld(Types.TIMESTAMP);
	/**
	 * The date type
	 */
	public static DataTypeOld DATE = new DataTypeOld(Types.DATE);
	/**
	 * The long type (aka. bigint)
	 */
	public static DataTypeOld LONG = new DataTypeOld(Types.BIGINT);
	/**
	 * The integer type
	 */
	public static DataTypeOld INTEGER = new DataTypeOld(Types.INTEGER);
	/**
	 * The double type
	 */
	public static DataTypeOld DOUBLE = new DataTypeOld(Types.DOUBLE);
	/**
	 * The boolean type
	 */
	public static DataTypeOld BOOLEAN = new DataTypeOld(Types.BOOLEAN);
	/**
	 * The string type (aka. varchar)
	 */
	public static DataTypeOld STRING = new DataTypeOld(Types.VARCHAR);
	/**
	 * The unknown / other type
	 */
	public static DataTypeOld OTHER = new DataTypeOld(Types.OTHER);
	 ...
	 * @see Types
	 */
	public DataTypeOld(int sqlType)
	{
		this.type = sqlType;
	}
	 ...
	 */
	public DataTypeOld(String typeString)
	{
	...
	{
		if (other instanceof DataTypeOld)
			return equals((DataTypeOld) other);
	 ...
	 */
	public boolean equals(DataTypeOld other)
	{
	...
	public static class InvalidDataTypeException extends RuntimeException
	{
		...
		private DataTypeOld usedType, correctType;
		 ...
		 */
		public InvalidDataTypeException(DataTypeOld usedType, DataTypeOld correctType, Object value)
		{
		 ...
		 * @see Types
		 */
		public DataTypeOld getUsedType()
		{
		 ...
		 * @see Types
		 */
		public DataTypeOld getCorrectType()
		{
