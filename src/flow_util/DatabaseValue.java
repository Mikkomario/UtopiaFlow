...
import flow_util.DataTypeOld.InvalidDataTypeException;
...
public class DatabaseValue
{
	...
	private DataTypeOld type;
	private Object value;
	
	
	// CONSTRUCTOR	------------------
	
	private DatabaseValue(DataTypeOld dataType)
	{
		this.type = dataType;
		setToNull();
	}
	
	private DatabaseValue(DataTypeOld dataType, Object value)
	{
		this.type = dataType;
		setValue(value);
	}
	 ...
	 */
	public DatabaseValue(DataTypeOld dataType, String string) throws InvalidDataTypeException
	{
		this.type = dataType;
		setValue(string);
	}
	 ...
	 */
	public DatabaseValue(DataTypeOld dataType, double numeric) throws InvalidDataTypeException
	{
		this.type = dataType;
		setValue(numeric);
	}
	 ...
	 */
	public DatabaseValue(DataTypeOld dataType, long numeric) throws InvalidDataTypeException
	{
		this.type = dataType;
		setValue(numeric);
	}
	 ...
	 */
	public DatabaseValue(DataTypeOld dataType, LocalDate date) throws InvalidDataTypeException
	{
		this.type = dataType;
		setValue(date);
	}
	 ...
	 */
	public DatabaseValue(DataTypeOld dataType, LocalDateTime date) throws InvalidDataTypeException
	{
		this.type = dataType;
		setValue(date);
	}
	 ...
	 * @throws InvalidDataTypeException If the value can't be parsed to the given data type
	 */
	public DatabaseValue(DataTypeOld dataType, Date date) throws InvalidDataTypeException
	{
		this.type = dataType;
		setValue(date);
	}
	 ...
	 * @throws InvalidDataTypeException If the value can't be parsed to the given data type
	 */
	public DatabaseValue(DataTypeOld dataType, Timestamp date) throws InvalidDataTypeException
	{
		this.type = dataType;
		setValue(date);
	}
	 ...
	 * @throws InvalidDataTypeException If the value can't be parsed to the given data type
	 */
	public DatabaseValue(DataTypeOld dataType, boolean bool) throws InvalidDataTypeException
	{
		this.type = dataType;
		setValue(bool);
	}
	 ...
	 */
	public DatabaseValue(DataTypeOld dataType, DatabaseValue value) throws InvalidDataTypeException
	{
		this.type = dataType;
	 ...
	 */
	public static DatabaseValue objectValue(DataTypeOld dataType, Object value) throws InvalidDataTypeException
	{
	 ...
	 */
	public static DatabaseValue nullValue(DataTypeOld dataType)
	{
	...
	{
		return new DatabaseValue(DataTypeOld.STRING, string);
	}
	...
	{
		return new DatabaseValue(DataTypeOld.DOUBLE, number);
	}
	...
	{
		return new DatabaseValue(DataTypeOld.LONG, number);
	}
	...
	{
		return new DatabaseValue(DataTypeOld.INTEGER, number);
	}
	...
	{
		return new DatabaseValue(DataTypeOld.DATE, date);
	}
	...
	{
		return new DatabaseValue(DataTypeOld.DATETIME, date);
	}
	...
	{
		return new DatabaseValue(DataTypeOld.BOOLEAN, bool);
	}
	 ...
	 */
	public DataTypeOld getDataType()
	{
		return this.type;
	}
	...
	private void setValue(String string) throws InvalidDataTypeException
	{
		if (string == null)
			...
			throw getDataInsertException(DataTypeOld.STRING, string);
	}
	...
	private void setValue(double numeric)
	{
		if (getDataType().isOfLongType())
			...
			throw getDataInsertException(DataTypeOld.DOUBLE, numeric);
	}
	...
	private void setValue(long numeric)
	{
		if (getDataType().isOfLongType())
			...
			throw getDataInsertException(DataTypeOld.LONG, numeric);
	}
	...
	private void setValue(LocalDate date)
	{
		if (date == null)
			...
			throw getDataInsertException(DataTypeOld.DATE, date);
		else if (getDataType().isOfDateType())
	...
	private void setValue(LocalDateTime date)
	{
		if (date == null)
			...
			throw getDataInsertException(DataTypeOld.DATETIME, date);
	}
	...
	private void setValue(boolean bool) throws InvalidDataTypeException
	{
		if (getDataType().isOfNumericType())
			...
			throw getDataInsertException(DataTypeOld.BOOLEAN, bool);
	}
	...
	public long toLong()
	{
		...
		throw getDataCastException(DataTypeOld.LONG);
	}
	...
	public int toInt() throws InvalidDataTypeException
	{
		...
		if (getDataType().isOfBooleanType())
			return toBoolean() ? 1 : 0;
		throw getDataCastException(DataTypeOld.INTEGER);
	}
	...
	public LocalDate toLocalDate() throws InvalidDataTypeException
	{
		...
		throw getDataCastException(DataTypeOld.DATE);
	}
	...
	public LocalDateTime toDateTime() throws InvalidDataTypeException
	{
		...
		throw getDataCastException(DataTypeOld.DATETIME);
	}
	...
	public boolean toBoolean() throws InvalidDataTypeException
	{
		...
		throw getDataCastException(DataTypeOld.BOOLEAN);
	}
	...
	public double toDouble() throws InvalidDataTypeException
	{
		...
		throw getDataCastException(DataTypeOld.DOUBLE);
	}
	...
	private static long valueAsLong(String value)
	{
		...
		{
			throw getDataCastException(DataTypeOld.STRING, DataTypeOld.LONG, value);
		}
	}
	...
	private static int valueAsInt(String value) throws InvalidDataTypeException
	{
		...
		{
			throw getDataCastException(DataTypeOld.STRING, DataTypeOld.INTEGER, value);
		}
	}
	...
	private static double valueAsDouble(String value) throws InvalidDataTypeException
	{
		...
		{
			throw getDataCastException(DataTypeOld.STRING, DataTypeOld.DOUBLE, value);
		}
	}
	...
	private static LocalDate valueAsDate(String value) throws InvalidDataTypeException
	{
		...
		catch (DateTimeParseException e)
		{
			...
			{
				throw getDataCastException(DataTypeOld.STRING, DataTypeOld.DATE, value);
			}
		}
	}
	...
	private static LocalDateTime valueAsDateTime(String value) throws InvalidDataTypeException
	{
		...
		catch (DateTimeParseException e)
		{
			...
			{
				throw getDataCastException(DataTypeOld.STRING, DataTypeOld.DATETIME, value);
			}
		}
	}
	
	private InvalidDataTypeException getDataInsertException(DataTypeOld usedDataType, 
			Object insertedValue)
	{
		return new InvalidDataTypeException(usedDataType, getDataType(), insertedValue);
	}
	
	private static InvalidDataTypeException getDataCastException(DataTypeOld fromCast, DataTypeOld toCast, 
			Object casted)
	{
		return new InvalidDataTypeException(fromCast, toCast, casted);
	}
	
	private InvalidDataTypeException getDataCastException(DataTypeOld correctDataType)
	{
