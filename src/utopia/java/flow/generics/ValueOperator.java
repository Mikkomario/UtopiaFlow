...
public interface ValueOperator
{
	 ...
	 * @throws ValueOperation.ValueOperationException If the operation fails
	 */
	public Value operate(Value first, Value second) throws ValueOperation.ValueOperationException;
