...
import utopia.java.flow.structure.iterator.EmptyIterator;
import utopia.java.flow.structure.iterator.FlatIterator;
import utopia.java.flow.structure.iterator.MapIterator;
import utopia.java.flow.structure.iterator.MergeIterator;
import utopia.java.flow.structure.iterator.RepeatingIterator;
...
public class View<T> implements RichIterable<T>
{
	 ...
	 */
	@SafeVarargs
	public final View<T> plus(RichIterable<? extends T> items, RichIterable<? extends T> moreItems,
							  RichIterable<? extends T>... evenMoreItems)
	{
